...
% ABOVE LINE NEEDS TESTING!
        ...
        beta_c{k} = ones(size(beta))*1e6;%alb-> size beta is wrong here?, changes with k?
        beta_c{k} = ones(size(beta{k}))*1e6;
